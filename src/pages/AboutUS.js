      ...
      <div className="about-us-products">
        <div className="about-us-product">
          <div className="about-us-card">
            <img className="about-us-card-img-top img-fluid" src="https://images.pexels.com/photos/298863/pexels-photo-298863.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
        ...
        <div className="about-us-product">
          <div className="about-us-card">
            <img className="about-us-card-img-top img-fluid" src="https://images.pexels.com/photos/7679720/pexels-photo-7679720.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
            <div className="about-us-card-title">
        ...
        <div className="about-us-product">
          <div className="about-us-card">
            <img className="about-us-card-img-top img-fluid" src="https://images.pexels.com/photos/1927259/pexels-photo-1927259.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
            <div className="about-us-card-title">
              <h5 className="text-center">Jewelry</h5>
            </div>
          </div>
        </div>
        <div className="about-us-product">
          <div className="about-us-card">
            <img className="about-us-card-img-top img-fluid" src="https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
            <div className="about-us-card-title">
